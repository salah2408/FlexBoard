...
<jsp:useBean id="categoryBean" class="de.hwg_lu.bwi520.beans.CategoryBean" scope="session" />
	...
	<div class="form-container">
		...
		<form action="./InserierenAppl.jsp" method="get">
			...
			<div class="row-gap">
				Titel 
				<input type="text" class="form-control" name="title" placeholder="Was bietest du an?" required>
			</div>

			<div class='row row-gap' style='margin-top: 20px;'>
				<div class='col-md-12'>
					Bilder hochladen 
					<input type='file' class='form-control' name='listingImage' id='bildUpload' accept='image/*' multiple>
				</div>
			...
			<div class="row-gap">
				Beschreibung
				<textarea class="form-control" name="descr" style="height: 150px;" placeholder="Details zu deinem Inserat..." required></textarea>
			</div>
			...
			<div id="testID" class="row row-gap">
				<div class="col-md-8">
					Ort
					 <input type="text" class="form-control" name="city" placeholder="Musterstadt">
				</div>
				<div class="col-md-4">
					PLZ
